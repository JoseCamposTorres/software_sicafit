...
$caso = $_GET['caso_situacional'] ?? '';
$usuario = $_GET['usu_id'] ?? '';
$delito = $_GET['deli_delito'] ?? '';

$datos = $consulta->get_datos($desde, $hasta, $caso, $usuario, $delito);
...
echo "<tr><td colspan='10'><strong>Desde:</strong> " . ($desde ?: 'No especificado') . " | <strong>Hasta:</strong> " . ($hasta ?: 'No especificado') . " | <strong>Caso Situacional:</strong> " . ($caso ?: 'No especificado') . " | <strong>Usuario:</strong> " . ($usuario ?: 'No especificado') . " | <strong>Delito:</strong> " . ($delito ?: 'No especificado') . "</td></tr>";
