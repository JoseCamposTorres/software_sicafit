                                    ...
                                    <div class="panel panel-body">
                                        ...
                                        <div class="container-fluid">
                                            <div class="box-typical box-typical-padding">
                                                <button type="button" id="btn_usuario_new" class="btn btn-inline btn-primary ladda-button" data-style="zoom-out"><i class="fa fa-plus-circle"></i> Ingresar Usuario</button>
                                                <br><br>
                                                <table id="usuario_data" class="table table-bordered table-vcenter js-dataTable-full">
                                                    <thead>
                                                        <tr>
