...
$(document).on("click", "#btnfiltrar", function () {
  var fecha_proceso_desde = $("#fecha_proceso_desde").val();
  var fecha_proceso_hasta = $("#fecha_proceso_hasta").val();
  if (fecha_proceso_hasta === "" || fecha_proceso_hasta === "") {
    Swal.fire({
      toast: true,
      position: "top-end",
      icon: "error",
...
function generar_excel(
  ...
  window.location.href =
    "../../excel/exportar_excel_controller.php?fecha_proceso_desde=" +
    fecha_proceso_desde +
    "&fecha_proceso_hasta=" +
    fecha_proceso_hasta +
    "&caso_situacional=" +
...
function listardatatable(
  ...
  /* TODO: rol si es 1 y 2  entonces es informatica o administrador */
  tabla = $("#consulta_data")
    .dataTable({
      aProcessing: true,
      aServerSide: true,
      ...
      ajax: {
        url: "../../controller/consultaController.php?op=listar_filtro",
        type: "post",
        dataType: "json",
        data: {
          fecha_proceso_desde: fecha_proceso_desde,
          fecha_proceso_hasta: fecha_proceso_hasta,
          caso_situacional: caso_situacional,
          usu_id: usu_id,
