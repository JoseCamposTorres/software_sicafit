$(document).ready(function () {
  ...
  $("#detenidosContainer").on("change", "#tipo_documento, .tipo-documento", function () {
    let select = $(this);
...
function Alphanumeric20(e) {
  ...
  if (fieldValue.length >= 20) {
    Swal.fire({
      ...
      position: "top-end",
      icon: "warning",
      title: "Solo se permiten 20 números",
      showConfirmButton: false,
      timer: 2000,
    });
    return false;
...
function Alpha12(e) {
  ...
  if (fieldValue.length >= 20) {
    Swal.fire({
      ...
      position: "top-end",
      icon: "warning",
      title: "Solo se permiten 12 números",
      showConfirmButton: false,
      timer: 2000,
    });
    return false;
