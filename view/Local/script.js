...
$(document).ready(function () {
    tabla = $('#local_data').dataTable({
     ...
     $.post("../../controller/localController.php?op=comboLocal", function (data, status) {
        $('#sede_id').html(data);
    });
});
...
function edit(loca_id) {
    ...
    $.post("../../controller/localController.php?op=view", { loca_id: loca_id }, function (data) {
...
function desactive(loca_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../../controller/localController.php?op=desactive", { loca_id: loca_id }, function (data) {
...
function active(loca_id) {  
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../../controller/localController.php?op=active", { loca_id: loca_id }, function (data) {
                let response = JSON.parse(data); 
                if (response.status === "success") {
                    $('#local_data').DataTable().ajax.reload();
                    Swal.fire({
